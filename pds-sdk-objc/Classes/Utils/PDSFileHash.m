...
+ (NSString *)hashOfData:(NSData *)data hashType:(PDSFileHashType)hashType {
    switch (hashType) {
        case PDSFileHashTypeNone:
            return nil;
        case PDSFileHashTypeMD5:
            return [self md5HashOfData:data];
        case PDSFileHashTypeSha1:
            return [self sha1HashOfData:data];
        case PDSFileHashTypeSha512:
...
+ (NSString *)hashOfFileAtPath:(NSString *)filePath hashType:(PDSFileHashType)hashType {
    switch (hashType) {
        case PDSFileHashTypeNone:
            return nil;
        case PDSFileHashTypeMD5:
            return [self md5HashOfFileAtPath:filePath];
        case PDSFileHashTypeSha1:
            return [self sha1HashOfFileAtPath:filePath];
        case PDSFileHashTypeSha512:
