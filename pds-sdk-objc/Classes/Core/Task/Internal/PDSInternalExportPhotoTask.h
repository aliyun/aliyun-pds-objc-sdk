...
typedef void (^PDSInternalExportPhotoResponseBlock)(BOOL success, NSString *localPath, NSString *fileName, NSError *error);

@interface PDSInternalExportPhotoTask : NSObject <PDSInternalTask>
